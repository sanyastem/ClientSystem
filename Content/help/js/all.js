...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Вход","2. Администратор","3.Менджер","Меню менеджеров","Услуги","Клиенты","Запись"],
    DREX_NODE_LINKS: ["index.htm","vkhod.htm","administrator.htm","3_mendzher.htm","menyu_menedzherov.htm","uslugi.htm","klienty.htm","zapis.htm"],
    DREX_NODE_CHILD_START: [1,4,4,6,8,8,8,8],
    DREX_NODE_CHILD_END: [4,4,6,8,8,8,8,8],
    DREX_MENU_TYPE: 2,
